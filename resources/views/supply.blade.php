...
<section class="py-2 text-center" style="">
    <h1 class="text-light center">supply</h1>
  </section><br><br>
<section class="text-dark lead">
  ...
  @endif
    ...
    <div class="form-group">
      <label for="pamount">Product Quantity:</label>
      <input type="text" class="form-control" id="pamount" name="pamount" placeholder="Enter Product Quantity">
    </div>
