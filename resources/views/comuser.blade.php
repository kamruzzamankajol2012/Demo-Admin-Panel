...
<body class="bg-dark">
  ...
  <nav class="navbar navbar-expand-md navbar-light navbar-laravel text-dark bg-warning fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{route('comuser')}}">
                    Company User
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                         <li class="nav-item">
                         <a class="nav-link" href="{{route('comuser')}}">Dashboard</a>
                        </li>
                         <li class="nav-item">
                        <a class="nav-link" href="{{route('comuser')}}">Product List</a>
                       </li>
...
<section class="py-2 text-center" style="">
    <h1 class="text-light center">Received Product List</h1>
  </section><br><br>
